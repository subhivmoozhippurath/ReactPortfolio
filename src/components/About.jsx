  ...
  return (
    ...
    >
      ...
      <div className="max-w-screen-lg mx-auto p-2">
        <p
          className="text-4xl  capitalize font-bold inline border-b-4 border-gray-500"
          data-aos="fade-up"
        >
          About
        </p>
      ...
      <div className="max-w-screen-lg mx-auto grid lg:grid-cols-2 pt-4 ">
        <div className="hidden relative lg:block lg:mt-6">
          <img
            className="absolute inset-0 w-9/12 h-9/12 object-cover object-center rounded-xl "
            src={benchwork}
            alt="logo"
            data-aos="fade-up"
          />
        ...
        <div className="px-8 py-12 max-w-md mx-auto sm:max-w-xl lg:px-2 lg:py-4 lg:max-w-screen-lg ">
          ...
          <div>
            <p
              className="mt-6 md:mt-2 text-2xl  text-gray-600 "
              data-aos="fade-down"
            >
              Experienced and versatile full stack developer proficient MERN
              Stack.
            </p>

            <p className="mt-6 text-2xl  text-gray-600 " data-aos="fade-left">
              Dedicated to continuously enhancing my skills and staying
              up-to-date with emerging technologies
            </p>

            <p className="mt-6 text-2xl  text-gray-600 " data-aos="fade-up">
              Committed to delivering exceptional results and continuously
              enhancing skills in a rapidly evolving tech landscape. Eager to be
              a part of a team which gives me ability to learn and grow.
            </p>
          </div>
        </div>
      </div>
